...
This is a small script that will help you automatically generate markdown and PDF documentation for your Apex classes.
...
- mdpdf (installable using setup.bat)
...
5) Run docGen.bat (or on non windows machines run "node generateDocs.js").
6) Witness glorious document generating goodness.